...
public:
  ...
  ~HpipmInterface() { std::cout << "Deleting Hpipm Interface" << std::endl; }
...
private:
  ...
  // min_x,u sum_k=0^N 1/2*[s_lower,k;s_upper,k]^T*[Z_lower,k , 0; 0 ,
  // Z_upper,k]*[s_lower,k;s_upper,k] + [z_lower,k; z_upper,k]^T*[s_lower,k;s_upper,k]
  ...
  // bounds that are different to stages bounds and need to be stored somewhere such the a pointer
  // can point
